...
> Note: You can refer [here](https://github.com/gluestack/gluestack-ui/tree/main/packages/themed/src/components/KeyboaardAvoidingView/styled-components) to learn about default styling of FlatList component
...
gluestack-ui KeyboardAvoidingView component is created using KeyboardAvoidingView component from react-native. It extends all the props supported by [React Native KeyboardAvoidingView](https://reactnative.dev/docs/keyboardAvoidingView#props), [React Native View](https://reactnative.dev/docs/view#props),[utility props](https://ui.gluestack.io/docs/styling/utility-and-sx-props)  and the props mentioned below.
