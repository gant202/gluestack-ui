...
gluestack-ui components are responsive. In order to manage that we define different **breakpoints** according to which styles are applied.

By default gluestack-ui provide basic breakpoint.
